...
public class IabHelper {
     ...
     * not block and is safe to call from a UI thread.
     *
     * decodedLPKStr is the application's public key, encoded in base64. This is used for
     ...
     *            billing service.
     */
    public IabHelper(Context ctx) throws UnsupportedEncodingException {
        mContext = ctx.getApplicationContext();
        mSignatureBase64 = "INSERT YOURS HERE";
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    if (response != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null)
                            listener.onIabSetupFinished(new IabResult(response, "Error checking "
                                    + "for billing v3 support."));
                ...
                if (listener != null) {
                    listener.onIabSetupFinished(new IabResult(BILLING_RESPONSE_RESULT_OK, "Setup " +
                            "" + "" + "" + "" + "" + "successful."));
                }
            }
        };
        ...
        if (intentServices != null && !intentServices.isEmpty()) {
            ...
            if (listener != null) {
                listener.onIabSetupFinished(new IabResult
                        (BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, "Billing service " +
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode,
                                   OnIabPurchaseFinishedListener listener) throws
    ...
    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener listener, String
                                                       extraData) throws
            IabAsyncInProgressException {
     ...
     */
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String>
            oldSkus, int requestCode, OnIabPurchaseFinishedListener listener, String extraData)
            throws IabAsyncInProgressException {
        checkNotDisposed();
        ...
        if (itemType.equals(ITEM_TYPE_SUBS) && !mSubscriptionsSupported) {
            IabResult r = new IabResult(IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE, "Subscriptions " +
                    "are" + " not available.");
            flagEndAsync();
        ...
        try {
            ...
            act.startIntentSenderForResult(pendingIntent.getIntentSender(), requestCode, new
                    Intent(), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0));
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            result = new IabResult(IABHELPER_UNKNOWN_PURCHASE_RESPONSE, "Unknown purchase " +
                    "response.");
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        return true;
     ...
     * @param moreSubsSkus    additional SUBSCRIPTIONS skus to query information on, regardless
     *                        of ownership.
     *                        Ignored if null or if querySkuDetails is false.
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        try {
            ...
            if (querySkuDetails) {
                ...
                if (r != BILLING_RESPONSE_RESULT_OK) {
                    throw new IabException(r, "Error refreshing inventory (querying prices of " +
                            "items).");
                }
            }
            ...
            if (mSubscriptionsSupported) {
                ...
                if (r != BILLING_RESPONSE_RESULT_OK) {
                    throw new IabException(r, "Error refreshing inventory (querying owned " +
                            "subscriptions).");
                }
                ...
                if (querySkuDetails) {
                    ...
                    if (r != BILLING_RESPONSE_RESULT_OK) {
                        throw new IabException(r, "Error refreshing inventory (querying prices "
                                + "of" + " subscriptions).");
                    }
                }
            }
            ...
            throw new IabException(IABHELPER_REMOTE_EXCEPTION, "Remote exception while " +
     ...
     */
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String>
            moreItemSkus, final List<String> moreSubsSkus, final QueryInventoryFinishedListener
            listener) throws IabAsyncInProgressException {
        ...
        (new Thread(new Runnable() {
            public void run() {
                IabResult result = new IabResult(BILLING_RESPONSE_RESULT_OK, "Inventory refresh "
                        + "successful.");
                Inventory inv = null;
                try {
    ...
    public void queryInventoryAsync(QueryInventoryFinishedListener listener) throws
            IabAsyncInProgressException {
    ...
    public void consume(Purchase itemInfo) throws IabException {
        ...
        if (!itemInfo.mItemType.equals(ITEM_TYPE_INAPP)) {
            throw new IabException(IABHELPER_INVALID_CONSUMPTION, "Items of type '" + itemInfo
                    .mItemType + "' can't be consumed.");
        }
        ...
        try {
            ...
            if (token == null || token.equals("")) {
                ...
                throw new IabException(IABHELPER_MISSING_TOKEN, "PurchaseInfo is missing token "
                        + "for sku: " + sku + " " + itemInfo);
            }
     ...
     */
    public void consumeAsync(Purchase purchase, OnConsumeFinishedListener listener) throws
            IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
    ...
    public static String getResponseDesc(int code) {
        String[] iab_msgs = ("0:OK/1:User Canceled/2:Unknown/" + "3:Billing Unavailable/4:Item "
                + "unavailable/" + "5:Developer Error/6:Error/7:Item Already Owned/" + "8:Item "
                + "not " + "owned").split("/");
        String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" +
                "-1002:Bad response received/" + "-1003:Purchase signature verification failed/"
                + "-1004:Send intent failed/" + "-1005:User cancelled/" + "-1006:Unknown " +
                "purchase" + " response/" + "-1007:Missing token/" + "-1008:Unknown error/" +
    ...
    void flagStartAsync(String operation) throws IabAsyncInProgressException {
        synchronized (mAsyncInProgressLock) {
            if (mAsyncInProgress) {
                throw new IabAsyncInProgressException("Can't start async operation (" + operation
                        + ") because another async operation (" + mAsyncOperation + ") is in " +
                        "progress.");
            }
        ...
        for (ArrayList<String> skuPartList : packs) {
            ...
            if (!skuDetails.containsKey(RESPONSE_GET_SKU_DETAILS_LIST)) {
                ...
                if (response != BILLING_RESPONSE_RESULT_OK) {
                    ...
                    logError("getSkuDetails() returned a bundle with neither an error nor a " +
                            "detail list.");
                    return IABHELPER_BAD_RESPONSE;
                }
            }
    ...
    void consumeAsyncInternal(final List<Purchase> purchases, final OnConsumeFinishedListener
            singleListener, final OnConsumeMultiFinishedListener multiListener) throws
            IabAsyncInProgressException {
        final Handler handler = new Handler();
        ...
        (new Thread(new Runnable() {
            public void run() {
                ...
                for (Purchase purchase : purchases) {
                    try {
                        consume(purchase);
                        results.add(new IabResult(BILLING_RESPONSE_RESULT_OK, "Successful " +
                                "consume" + " of sku " + purchase.getSku()));
                    } catch (IabException ex) {
